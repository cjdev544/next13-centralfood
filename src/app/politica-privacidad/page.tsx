...
export default function Politic() {
  return (
    <>
      {/* <Head>
        <title>Privacidad | CentralFoodMalaga</title>
        <meta
          name='description'
      ...
      <main>
        <div className='legal'>
          ...
          <p>
            ...
            CentralFood Málaga usa y protege la información que es proporcionada
          ...
          <p>
            ...
            CentralFood Málaga está altamente comprometido para cumplir con el
          ...
          <p>
            ...
            judicial. CentralFood Málaga Se reserva el derecho de cambiar los
